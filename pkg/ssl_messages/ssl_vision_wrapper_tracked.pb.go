...
var file_ssl_vision_wrapper_tracked_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_ssl_vision_wrapper_tracked_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ssl_vision_wrapper_tracked_proto_msgTypes[0].Exporter = func(v any, i int) any {
